                    ...
                    >
                      <div className="flex items-start gap-4 mb-3">
                        {membership.va_logo_url ? (
                          <div className="w-16 h-16 flex-shrink-0 bg-white rounded-lg p-2 border-2 border-slate-200">
                            <img src={membership.va_logo_url} alt={membership.va_name} className="w-full h-full object-contain" />
                          </div>
                        ) : (
                          <div className="w-16 h-16 flex-shrink-0 bg-gradient-to-br from-aviation-400 to-aviation-600 rounded-lg flex items-center justify-center text-white text-2xl font-bold">
                            {membership.va_callsign?.charAt(0) || membership.va_name?.charAt(0) || 'VA'}
                          </div>
                        )}
                      ...
                      <div className="flex gap-2">
                        <Link
                          href={`/va/${membership.va_id}/pilot/dashboard`}
                          className="flex-1 px-4 py-2 bg-aviation-600 hover:bg-aviation-700 text-white font-semibold rounded-lg text-center transition-colors text-sm"
                        >
                          ✈️ Pilot Dashboard
                        </Link>
                        <Link
